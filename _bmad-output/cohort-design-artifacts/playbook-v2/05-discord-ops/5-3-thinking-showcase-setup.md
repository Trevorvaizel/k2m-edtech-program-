...
- [ ] **3. Document Publication Flow** (AC: #3, Decision 12)
  - [ ] 3.1 Specify private DM â†’ public showcase publication workflow
...
- [ ] **4. Implement Celebration Culture Design** (AC: #4, Guardrail #3)
  ...
  - [ ] 4.2 Specify emoji reaction system (â­ celebration, not ðŸ”¥ competition)
...
- [ ] **6. Specify Bot Automation & Safety** (AC: #6)
  - [ ] 6.1 Document bot publication workflow (validate â†’ publish â†’ celebrate)
...
Section 3 (Publication Flow):
  â†’ See Story 4.7, Section 5.2: /publish-command API implementation
  â†’ See Story 4.7, Section 5.3: DM channel publication workflow
  â†’ Discord.py code: `await channel.send(celebration_message)`

Section 6 (Bot Automation & Safety):
  â†’ See Story 4.7, Section 3.1: Bot initialization and Discord client setup
  â†’ See Story 4.7, Section 4.1: Message handler registration
  â†’ See Story 4.7, Section 6.2: Claude API integration for celebration generation

Section 6.2 (SafetyFilter):
  â†’ See Story 4.6, Section 5: SafetyFilter prompt specification
  â†’ See Story 4.7, Section 7: Moderation workflow implementation
  â†’ Guardrail validation: Code-level enforcement

Section 7 (Parent Email System):
  â†’ See Story 4.7, Section 8: Email queue and batch processing
  â†’ SendGrid/Mailgun integration: API call implementation
  â†’ Error handling: Retry logic and alerting

DEPENDENCY MAPPING:
  Story 5.3 (this story) â†’ Specification layer (WHAT)
  Story 4.7 (bot technical) â†’ Implementation layer (HOW)
  Story 4.6 (artifact flow) â†’ Data structures (artifact schema)
...
2. **Guardrail #8 (Discord Safety):**
   - Private process (DMs) â†’ Public product (#thinking-showcase) architecture
...
- **Node-Specific Celebrations:**
  ...
  - Makes abstract habits concrete: Habit 3 (ðŸ”„ ITERATE) becomes visible as Node 3.1-3.4
- **Identity Evidence:** Artifacts show node concepts in action

**4. 4 Habits Branding (Story 1.4):**
- **Habit 1 â¸ï¸ Pause:** Celebrated in Weeks 1-5
- **Habit 2 ðŸŽ¯ Context:** Celebrated in Weeks 1-5
- **Habit 3 ðŸ”„ Iterate:** Celebrated in Weeks 4-7
- **Habit 4 ðŸ§  Think First:** Celebrated in Weeks 6-8
...
```yaml
#thinking-showcase (ðŸŒŸ Thinking Showcase)
  â†’ Purpose: Published artifacts, celebration only
  â†’ Pattern: Student publishes â†’ bot celebrates
  â†’ Permissions: Read-only (students), bot publishes
  â†’ Decision 12: Public celebration of private work
```
...
Step 3A: If Student Chooses [Yes] â†’ Story 5.3 Publication Workflow
...
1. **Public Publication (Default)**
   - Bot publishes with: "ðŸŒŸ [Student Name] practiced Habits 1 & 2 today!"
...
2. **Anonymous Publication**
   - Bot publishes with: "ðŸŒŸ Anonymous student practiced Habits 1 & 2 today!"
   - Artifact visible to all students
...
Student Consent (Story 5.2, Section 2.2):
  Week 1 onboarding: Student chooses parent update preference
    - Option A: "Share weekly progress" â†’ Parents get Monday weekly email
    - Option B: "Privacy first" â†’ No updates until Week 8 artifact showcase
...
## 3. Publication Flow (Private DM â†’ Public Showcase)
...
Step 1.2: Bot Offers Showcase Share (Story 5.2, Section 4.2)
  ...
  Bot: "Great! Want to share your learning to #thinking-showcase?
        [Yes] â†’ I'll post a celebration (not our private conversation)
        [No] â†’ Conversation stays private (saved for your artifact later)
        [Maybe later] â†’ I'll remind you in Week 6 when artifact starts
...
Step 2.2: Bot Generates Celebration Message (Claude API)
  Template-based with personalization:
    - Habit practice: "ðŸŒŸ [Student Name] practiced Habits 1 & 2 today!"
    - Artifact: "ðŸŒŸ [Student Name] completed their Thinking Artifact!"
  
  Personalization elements:
    - Specific habits demonstrated: "They paused before asking (â¸ï¸ PAUSE)"
...
Step 3.1: Bot Publishes Celebration Post
  Bot posts to #thinking-showcase:
    "ðŸŒŸ [Student Name] practiced Habits 1 & 2 today!
     
     They paused to clarify what they want (â¸ï¸ PAUSE).
     They explained their situation first (ðŸŽ¯ CONTEXT).
     
     That's thinking WITH AI, not copying FROM it.
     
     Tools change. Habits transfer. â¸ï¸ðŸŽ¯"
  
  Bot adds initial reaction: â­ (models celebration behavior)

Step 3.2: Students React (Celebration Culture)
  Students see: Celebration post in #thinking-showcase
  Students react: â­ (star), â¤ï¸ (heart), ðŸŽ‰ (party)
...
Step 3.3: Bot DMs Confirmation to Student
  Bot: "Posted! Your growth is inspiring others. ðŸŒŸ
...
Option 1: Public Publication (Default)
  ...
  Celebrated in: Channel with emoji reactions (â­â¤ï¸ðŸŽ‰)
...
Celebration Template:
  "ðŸŒŸ [Student/Anonymous] practiced Habit [X] & [Y] today!
...
Example (Habit 1 & 2):
  "ðŸŒŸ [Student] practiced Habits 1 & 2 today!
   ...
   That's thinking WITH AI. Skills that follow you forever. â¸ï¸ðŸŽ¯"
...
Celebration Template:
  "ðŸŒŸ [Student/Anonymous] completed their Thinking Artifact!
...
Example (University Career Artifact):
  "ðŸŒŸ [Student] completed their Thinking Artifact!
...
Celebration Template:
  "ðŸŽ“ [Student/Anonymous] earned the 4 Habits Card!
   
   â¸ï¸ PAUSE - They know what they want
   ðŸŽ¯ CONTEXT - They explain their situation
   ðŸ”„ ITERATE - They change one thing at a time
   ðŸ§  THINK FIRST - They decide with AI
   ...
   You're ready for university. You're ready for life. ðŸŒŸ"

Example:
  "ðŸŽ“ [Student] earned the 4 Habits Card!
...
Initial Consent (Week 1 Onboarding):
  During #welcome channel onboarding:
    ...
    Option A: âœ… "Share weekly progress" â†’ Parents get Monday weekly email
    Option B: âŒ "Privacy first" â†’ No updates until Week 8
...
Week 8 Artifact Showcase (Final Celebration):
  Eligible students: Parents receive Friday Week 8 report at 9:00 AM EAT
  Eligibility: Artifact published + parent not opted-out
  Student choice: Public OR Anonymous can send report; Private to Trevor requires explicit share consent workflow
...
Privacy Guarantees:
  ...
  - Parents can opt-out anytime via email unsubscribe link (hard stop for future sends)
  - Student can change weekly/privacy preference anytime (no locked-in choices)
...
1. Individual Celebrations (Identity-Focused):
   - "ðŸŒŸ [Student] practiced Habit 1 & 2 today!"
...
FORBIDDEN Patterns (Guardrail #3 Violations):
   ...
   NEVER say:
     - "Top student this week" âŒ
     - "Best artifact" âŒ
     - "Most active" âŒ
     - "Faster than others" âŒ
     - "Ahead of the cohort" âŒ
     - "Better than [other student]" âŒ
     - "Ranking: 1st, 2nd, 3rd" âŒ
...
```yaml
Allowed Reactions:
  - â­ (Star) = "I celebrate your growth!"
  - â¤ï¸ (Heart) = "This inspires me!"
  - ðŸŽ‰ (Party) = "Another transformation complete!"
  - ðŸ‘ (Clap) = "Respect for your journey!"

Forbidden Reactions (Implicit Comparison):
  - ðŸ”¥ (Fire) - "Hot/best" (competition implied)
  - ðŸ† (Trophy) - "Winner/ranking" (comparison)
  - ðŸ’¯ (100) - "Perfect/best" (implicit ranking)
  - ðŸ“ˆ (Chart) - "Progress/growth curve" (quantification)

Enforcement:
  - Bot models: â­ reaction on every publication
...
```
ðŸŒŸ WEEKLY MILESTONE: [X] students published artifacts this week!
...
Week 1 (Wonder - Zone 0â†’1):
  Celebrations: Habit 1 (â¸ï¸ PAUSE) practice
  Bot posts: "ðŸŒŸ [Student] paused before asking AI today!"
  Aggregate: "45 students practiced Habit 1 this week!"
  Message: "Week 1 is about Wonder - noticing AI is already around you"

Weeks 2-3 (Trust - Zone 1â†’2):
  Celebrations: Habit 1 & 2 (â¸ï¸ðŸŽ¯) practice
  Bot posts: "ðŸŒŸ [Student] explained their situation first!"
  Aggregate: "89 students are building Habit 2 this week!"
  Message: "Weeks 2-3 build Trust through small wins"

Weeks 4-5 (Converse - Zone 2â†’3):
  Celebrations: Habit 3 (ðŸ”„ ITERATE) exploration
  Bot posts: "ðŸŒŸ [Student] explored 3 career possibilities!"
...
```yaml
Week 6-7 (Direct - Zone 3â†’4):
  Celebrations: Artifact section completions
  Bot posts: "ðŸŒŸ [Student] completed 3 artifact sections!"
...
Week 8 (Artifact Completion & Showcase):
  ...
  Bot posts: "ðŸŽ“ [Student] earned the 4 Habits Card!"
...
Cohort Completion Ritual:
  Bot posts: "ðŸŒŸ COHORT GRADUATION COMPLETE!
  
  127 graduates proved they're someone who thinks with AI!
  
  â¸ï¸ PAUSE - You know what you want
  ðŸŽ¯ CONTEXT - You explain your situation
  ðŸ”„ ITERATE - You change one thing at a time
  ðŸ§  THINK FIRST - You decide with AI
...
Step 2: Validation (SafetyFilter)
  ...
  - No comparison/ranking language? âœ…
  - Revolutionary Hope tone? âœ…
  - JTBD-relevant examples? âœ…
...
Step 3: Publication
  ...
  Bot adds: â­ reaction (models celebration behavior)

Step 4: Confirmation
  Bot DMs student: "Posted! Your growth is inspiring others. ðŸŒŸ"
```
...
Celebration Generation System Prompt:
  "You are a celebration bot for K2M AI Thinking Skills Cohort.
   ...
   6. Use Habit icons: â¸ï¸ðŸŽ¯ðŸ”„ðŸ§ 
   ...
   "ðŸŒŸ [Student] practiced Habit 1 today!
    ...
    That's clarity first, answers second. â¸ï¸"

   Example 3 (Habit 3 - Career exploration):
   "ðŸŒŸ [Student] practiced Habit 3 (ðŸ”„ ITERATE) today!
   ...
   âŒ "Best artifact this week!" (comparison)
   âŒ "You're ahead of the cohort!" (ranking)
   âŒ "Most active student!" (competition)
   âŒ "You should practice more!" (pressure)
   âŒ "Here's a cat who learned to pause" (non-JTBD example)
   âŒ "Solve this riddle about AI" (trivial content)
...
â€¢ Habit 1 (â¸ï¸ PAUSE) - [X] times
â€¢ Habit 2 (ðŸŽ¯ CONTEXT) - [Y] times
â€¢ Habit 3 (ðŸ”„ ITERATE) - [Z] times (if Week 4+)
â€¢ Habit 4 (ðŸ§  THINK FIRST) - [W] times (if Week 6+)

ðŸ’¡ KEY MILESTONES
â€¢ Had [N] /frame conversations about [topic: university, career, study]
â€¢ Built Node [X.Y]: "[Node title from Story 1.3]"
â€¢ [Specific insight or growth moment from celebrations]
...
â€¢ Pause before asking â†’ Know what you want
â€¢ Explain context first â†’ AI responds to YOUR situation
â€¢ Change one thing at a time â†’ Learn through experimentation
â€¢ Think before decisions â†’ Make better choices
...
P.S. Your child chose to share these updates. You can opt-out anytime via the unsubscribe link in this email.
```
...
Card Design:
  ...
  Icons: â¸ï¸ðŸŽ¯ðŸ”„ðŸ§  (all 4 habits)
  Student Name: [Student Name]
  Cohort: K2M AI Thinking Skills Cohort #X
  Date: [Completion Date]

Back: "THE 4 HABITS"
  â¸ï¸ PAUSE - I know what I want before asking
  ðŸŽ¯ CONTEXT - I explain my situation first
  ðŸ”„ ITERATE - I change one thing at a time
  ðŸ§  THINK FIRST - I use AI before decisions
...
```yaml
Bot Posts to #thinking-showcase:
  "ðŸŒŸ COHORT GRADUATION COMPLETE!
...
- [x] **AC #3: Publication Flow** - Documents private DM â†’ public showcase workflow with privacy controls
...
- [x] **4 Habits Branding (Story 1.4):** â¸ï¸ðŸŽ¯ðŸ”„ðŸ§  icons throughout, graduation card
...
1. âœ… **Channel Purpose & Philosophy:** Defined #thinking-showcase as celebration-only destination for finished thinking growth
2. âœ… **Channel Configuration:** Complete Discord settings, read-only permissions for students, bot publisher role
3. âœ… **Publication Flow:** Complete workflow from private DM â†’ public celebration with privacy controls (Yes/No/Anonymous)
4. âœ… **Celebration Culture:** Guardrail #3 compliance through celebration-only patterns, emoji reactions, aggregate visibility
5. âœ… **Weekly Progression:** Week 1-8 evolution from habit practice celebrations through graduation rituals
6. âœ… **Bot Automation & Safety:** Publication workflow, SafetyFilter validation, celebration templates, moderation
7. âœ… **JTBD Social Job:** Parent engagement system (with student consent), peer learning, future-self evidence
8. âœ… **Graduation Celebration:** Week 8 artifact showcase, 4 Habits card awarding, cohort completion rituals
...
- **Epic 1 (4 Habits):** â¸ï¸ðŸŽ¯ðŸ”„ðŸ§  icons throughout, graduation card designed
...
**Story 5.3 Status: âœ… READY FOR DEVELOPMENT (ADVERSARIAL REVIEW FIXES APPLIED)**
...
- âœ… Complete channel purpose and philosophy (public celebration destination, JTBD social job)
- âœ… Full Discord configuration (read-only for students, bot publisher permissions)
- âœ… Publication flow (private DM â†’ public celebration with privacy controls)
- âœ… Celebration culture design (Guardrail #3 compliance, emoji reactions, aggregate visibility)
- âœ… Weekly channel progression (Week 1-8 evolution from habit practice to graduation)
- âœ… Bot automation & safety (publication workflow, SafetyFilter validation, moderation)
- âœ… JTBD social job integration (parent engagement with consent, peer learning, future evidence)
- âœ… Graduation & 4 Habits celebration (Week 8 showcase, graduation cards, cohort rituals)
- âœ… All 8 Acceptance Criteria met
- âœ… All Epic 1, 2, 4 foundations integrated

**ADVERSARIAL REVIEW FIXES APPLIED (7 HIGH + 3 MEDIUM):**

**HIGH-Severity Fixes (All Applied):**
1. âœ… **HIGH #1:** Parent email technical implementation specified (SendGrid/Mailgun, error handling, queue system)
2. âœ… **HIGH #2:** Complete database schema defined (showcase_publications, parent_engagement, student_publication_preferences)
3. âœ… **HIGH #3:** Story 4.7 cross-references added (dependency mapping, developer handoff)
4. âœ… **HIGH #4:** Claude API prompt engineering specified (system prompt, few-shot examples, testing protocol)
5. âœ… **HIGH #5:** Anonymous privacy leak fixed (parents NOT notified for anonymous publications)
6. âœ… **HIGH #6:** "Private to Trevor" Week 8 contradiction fixed (parent notification now opt-in)
7. âœ… **HIGH #7:** Permanent publication preference setting added (reduces decision fatigue)

**MEDIUM-Severity Fixes (Priority Issues Applied):**
1. âœ… **MEDIUM #1:** Diverse celebration examples added (prevents implicit comparison, celebrates different paths)
2. âœ… **MEDIUM #2:** Week 1 parent notification warning added (sets expectations, avoids Week 8 surprise)
3. âœ… **MEDIUM #3:** Artifact incomplete handling specified (Week 8 extension, no-artifact graduation)
